...
import Vanilla from '../../img/ice3.jpg'

import Vanilla1 from '../../img/icenmaking2.jpg'
import Vanilla2 from '../../img/icemaking9.jpg'

export default function ChocoBerry() {
  return (
    <>
      <div className="container recipe-content">

        <img src={Vanilla} alt="" className="img-responsive  recipe-img" />
        <h1>Vanilla</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Vanilla</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Vanilla1} alt="" className="img-reponsive"></img>
            <img src={Vanilla2} alt="" className="img-reponsive"></img>
            <img src={Vanilla} alt="" className="img-reponsive"></img>
          </div>
