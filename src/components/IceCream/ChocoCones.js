...
import Chococones from '../../img/ice8.jpg'

import Chococones1 from '../../img/icemaking5.jpg'
import Chococones2 from '../../img/icemaking6.jpg'

export default function ChocoCones() {
  return (
    <>
      <div className="container recipe-content">

        <img src={Chococones} alt="" className="img-responsive  recipe-img" />
        <h1>Choco Cone</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Choco cone</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Chococones1} alt="" className="img-reponsive"></img>
            <img src={Chococones2} alt="" className="img-reponsive"></img>
            <img src={Chococones} alt="" className="img-reponsive"></img>
          </div>
