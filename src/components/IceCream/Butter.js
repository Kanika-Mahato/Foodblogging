...
import Butter from '../../img/ice5.jpg'

import Butter1 from '../../img/icemaking1.jpg'
import Butter2 from '../../img/icemaking3.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={Butter} alt="" className="img-responsive  recipe-img" />
        <h1>Butter </h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Butter Scotch</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Butter1} alt="" className="img-reponsive"></img>
            <img src={Butter2} alt="" className="img-reponsive"></img>
            <img src={Butter} alt="" className="img-reponsive"></img>
          </div>
