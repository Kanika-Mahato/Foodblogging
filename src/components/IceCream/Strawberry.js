...
import Strawberry from '../../img/ice4.jpg'
import Strawberry1 from '../../img/icenmaking2.jpg'
import Strawberry2 from '../../img/icemaking4.webp'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={Strawberry} alt="" className="img-responsive  recipe-img" />
        <h1>Strawberry</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Strawberry Berry</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Strawberry1} alt="" className="img-reponsive"></img>
            <img src={Strawberry2} alt="" className="img-reponsive"></img>
            <img src={Strawberry} alt="" className="img-reponsive"></img>
          </div>
