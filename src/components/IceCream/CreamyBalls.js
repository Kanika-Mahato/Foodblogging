...
import Creamyballs from '../../img/ice-cream.jpg'

import Creamyballs1 from '../../img/icemaking8.jpg'
import Creamyballs2 from '../../img/icemaking14.jpg'

export default function CreamyBalls() {
  return (
    <>
      <div className="container recipe-content">

        <img src={Creamyballs} alt="" className="img-responsive  recipe-img" />
        <h1>Creamy Balls</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Creamy Berry</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Creamyballs1} alt="" className="img-reponsive"></img>
            <img src={Creamyballs2} alt="" className="img-reponsive"></img>
            <img src={Creamyballs} alt="" className="img-reponsive"></img>
          </div>
