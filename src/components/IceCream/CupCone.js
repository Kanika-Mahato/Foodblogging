...
import Cupcone from '../../img/ice7.jpg'

import Cupcone1 from '../../img/icemaking9.jpg'
import Cupcone2 from '../../img/icemaking8.jpg'
export default function CupCone() {
  return (
    <>
      <div className="container recipe-content">

        <img src={Cupcone} alt="" className="img-responsive  recipe-img" />
        <h1>Cup Cone</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Cup cone</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Cupcone1} alt="" className="img-reponsive"></img>
            <img src={Cupcone2} alt="" className="img-reponsive"></img>
            <img src={Cupcone} alt="" className="img-reponsive"></img>
          </div>
