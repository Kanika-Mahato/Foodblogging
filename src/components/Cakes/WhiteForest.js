...
import WhiteForest from '../../img/cake2.jpg'

import WhiteForest1 from '../../img/whitemaking2.jpg'
import WhiteForest2 from '../../img/white forest cake 1.jpg'

export default function Whiteforest() {
  return (
    <>
      <div className="container recipe-content">

        <img src={WhiteForest} alt="" className="img-responsive  recipe-img" />
        <h1>White Forest cake</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make whiteForest</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={WhiteForest1} alt="" className="img-reponsive"></img>
            <img src={WhiteForest2} alt="" className="img-reponsive"></img>
            <img src={WhiteForest} alt="" className="img-reponsive"></img>
          </div>
