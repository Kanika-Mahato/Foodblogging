...
import Chocoberry from '../../img/cake5.jpg'
import Chocoberry1 from '../../img/chocomaking2.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={Chocoberry} alt="" className="img-responsive  recipe-img" />
        <h1>Choco Berry cake</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Choco Berry</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Chocoberry1} alt="" className="img-reponsive"></img>
            <img src={Chocoberry} alt="" className="img-reponsive"></img>
            <img src={Chocoberry} alt="" className="img-reponsive"></img>
          </div>
