...
import cdocomonster from '../../img/cake6.jpg'
import cdocomonster1 from '../../img/chocomaking2.jpg'

export default function cdocoMonster() {
  return (
    <>
      <div className="container recipe-content">

        <img src={cdocomonster} alt="" className="img-responsive  recipe-img" />
        <h1>Choco Monster</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Choco Monster</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={cdocomonster1} alt="" className="img-reponsive"></img>
            <img src={cdocomonster} alt="" className="img-reponsive"></img>
            <img src={cdocomonster} alt="" className="img-reponsive"></img>
          </div>
