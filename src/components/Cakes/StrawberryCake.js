...
import StrawberryCake from '../../img/cake8.jpg'
import StrawberryCake1 from '../../img/Strawberry-Cake-3.jpg'

import StrawberryCake2 from '../../img/strawberrycakemake1.jpg'
import StrawberryCake3 from '../../img/strawberrymake2.jpg'

export default function Strawberrycake() {
  return (
    <>
      <div className="container recipe-content">

        <img src={StrawberryCake} alt="" className="img-responsive  recipe-img" />
        <h1>StrawBerry Cup cake</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make StrawBerry cake</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={StrawberryCake1} alt="" className="img-reponsive"></img>
            <img src={StrawberryCake2} alt="" className="img-reponsive"></img>
            <img src={StrawberryCake3} alt="" className="img-reponsive"></img>
          </div>
