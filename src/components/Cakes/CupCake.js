...
import Cupcake from '../../img/cake9.jpg'

import Cupcake1 from '../../img/cupmaking1.jpg'

import Cupcake2 from '../../img/cupmaking2.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={Cupcake} alt="" className="img-responsive  recipe-img" />
        <h1>Cup cake</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Cup cake</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Cupcake1} alt="" className="img-reponsive"></img>
            <img src={Cupcake2} alt="" className="img-reponsive"></img>
            <img src={Cupcake} alt="" className="img-reponsive"></img>
          </div>
