...
import Chocolatecake from '../../img/cake3.jpg'

import Chocolatecake1 from '../../img/chocolate-cake-1.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={Chocolatecake} alt="" className="img-responsive  recipe-img" />
        ...
        <div className="row recipe-menu">
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={Chocolatecake1} alt="" className="img-reponsive"></img>
            <img src={Chocolatecake} alt="" className="img-reponsive"></img>
            <img src={Chocolatecake} alt="" className="img-reponsive"></img>
          </div>
