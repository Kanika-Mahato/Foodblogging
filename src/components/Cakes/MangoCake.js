...
import MangoCake from '../../img/cake4.jpg'

export default function Mangocake() {
  return (
    <>
      <div className="container recipe-content">

        <img src={MangoCake} alt="" className="img-responsive  recipe-img" />
        <h1>Mango cake</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make mango cake</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={MangoCake} alt="" className="img-reponsive"></img>
            <img src={MangoCake} alt="" className="img-reponsive"></img>
            <img src={MangoCake} alt="" className="img-reponsive"></img>
          </div>
