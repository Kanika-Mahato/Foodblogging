...
import sandesh1 from '../../img/gulabjamunmaking2.jpg'
import sandesh2 from '../../img/sandeshmaking2.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={sandesh} alt="" className="img-responsive  recipe-img" />
        <h1>Sandesh</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Sandesh</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={sandesh1} alt="" className="img-reponsive"></img>
            <img src={sandesh2} alt="" className="img-reponsive"></img>
            <img src={sandesh} alt="" className="img-reponsive"></img>
          </div>
