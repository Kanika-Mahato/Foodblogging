...
import './Ladoo.css'
import kheer from '../../img/kheer1.jpg'

import kheer1 from '../../img/rice-kheermaking2.jpg'
import kheer2 from '../../img/rice-kheer.jpg'

export default function Kheer() {
  return (
    <>
      <div className="container recipe-content">

        <img src={kheer} alt="" className="img-responsive  recipe-img" />
        <h1>Kheer</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Kheer</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={kheer1} alt="" className="img-reponsive"></img>
            <img src={kheer2} alt="" className="img-reponsive"></img>
            <img src={kheer} alt="" className="img-reponsive"></img>
          </div>
