...
import ladoo31 from '../../img/motichoor-ladoo-making.jpg'
import ladoo32 from '../../img/motichurmaking1.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={ladoo3} alt="" className="img-responsive  recipe-img" />
        <h1>Ladoo</h1>
        <div className="row recipe-menu">
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={ladoo31} alt="" className="img-reponsive"></img>
            <img src={ladoo32} alt="" className="img-reponsive"></img>
            <img src={ladoo3} alt="" className="img-reponsive"></img>
          </div>
