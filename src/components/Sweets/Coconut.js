...
import ladoo71 from '../../img/coconut-laddu-step-1.jpg'
import ladoo72 from '../../img/coconutmaking2.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={ladoo7} alt="" className="img-responsive  recipe-img" />
        <h1>Ladoo</h1>
        <div className="row recipe-menu">
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={ladoo71} alt="" className="img-reponsive"></img>
            <img src={ladoo72} alt="" className="img-reponsive"></img>
            <img src={ladoo7} alt="" className="img-reponsive"></img>
          </div>
