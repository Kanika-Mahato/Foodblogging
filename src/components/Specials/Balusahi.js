...
import balusahi1 from '../../img/balusahimaking1.jpg'
import balusahi2 from '../../img/balusahimaking2.jpg'

export default function Balusahi(){
  return (
    <>
      <div className="container recipe-content">

        <img src={balusahi} alt="" className="img-responsive  recipe-img" />
        <h1>Balusahi</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Motichoor Laddoo</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={balusahi1}alt="" className="img-reponsive"></img>
            <img src={balusahi2} alt="" className="img-reponsive"></img>
            <img src={balusahi} alt="" className="img-reponsive"></img>
          </div>
