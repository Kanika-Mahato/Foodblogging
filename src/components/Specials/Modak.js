...
import modak1 from '../../img/modakmaking1.jpg'
import modak2 from '../../img/modakmaking2.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={modak} alt="" className="img-responsive  recipe-img" />
        <h1>Modak</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Modak</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={modak1} alt="" className="img-reponsive"></img>
            <img src={modak2} alt="" className="img-reponsive"></img>
            <img src={modak} alt="" className="img-reponsive"></img>
          </div>
