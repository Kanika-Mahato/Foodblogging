...
import gulabjamun1 from '../../img/ice-cream-recipe-13.jpg'
import gulabjamun2 from '../../img/jamun-ingredientsmaking1.jpg'
  ...
  return (
    <>
      <div className="container recipe-content">
        ...
        <img src={gulabjamun} alt="" className="img-responsive  recipe-img" />
        <h1>Gulabjamun</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Gulabjamun</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={gulabjamun1} alt="" className="img-reponsive"></img>
            <img src={gulabjamun2} alt="" className="img-reponsive"></img>
            <img src={gulabjamun} alt="" className="img-reponsive"></img>
          </div>
