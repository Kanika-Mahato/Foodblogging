...
import anarsa1 from '../../img/images.jpg'
import anarsa2 from '../../img/anarsamaking2.jpg'

export default function Anarsa() {
  return (
    <>
      <div className="container recipe-content">

        <img src={anarsa} alt="" className="img-responsive  recipe-img" />
        <h1>Anarsa</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Anarsa</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={anarsa1} alt="" className="img-reponsive"></img>
            <img src={anarsa2} alt="" className="img-reponsive"></img>
            <img src={anarsa} alt="" className="img-reponsive"></img>
          </div>
