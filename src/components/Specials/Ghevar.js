...
import ghewar1 from '../../img/ghevar1.jpg'
import ghewar2 from '../../img/ghevar2.jpg'
import ghewar3 from '../../img/ghevar3.jpg'

export default function Ghevar() {
  return (
    <>
      <div className="container recipe-content">

        <img src={ghewar} alt="" className="img-responsive  recipe-img" />
        <h1>Ghevar</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Ghevar</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={ghewar1} alt="" className="img-reponsive"></img>
            <img src={ghewar2} alt="" className="img-reponsive"></img>
            <img src={ghewar3} alt="" className="img-reponsive"></img>
          </div>
