...
import khaja1 from '../../img/khajamaking0.jpg'
import khaja2 from '../../img/khajamaking1.jpg'

export default function Khaja() {
  return (
    <>
      <div className="container recipe-content">

        <img src={khaja} alt="" className="img-responsive  recipe-img" />
        <h1>Khaja</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Khaja</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={khaja1} alt="" className="img-reponsive"></img>
            <img src={khaja2} alt="" className="img-reponsive"></img>
            <img src={khaja} alt="" className="img-reponsive"></img>
          </div>
