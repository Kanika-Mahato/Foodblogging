...
import pinni1 from '../../img/pinni1.jpg'
import pinni2 from '../../img/pinni2.jpg'

export default function Pinni() {
  return (
    <>
      <div className="container recipe-content">

        <img src={pinni} alt="" className="img-responsive  recipe-img" />
        <h1>Pinni</h1>
        <div className="row recipe-menu">
          <div className="col-sm-8 recipe-text">
            <h2>How to make Pinni</h2>
          ...
          <div className="col-sm-4 recipe-otherimg">
            <img src={pinni1} alt="" className="img-reponsive"></img>
            <img src={pinni2} alt="" className="img-reponsive"></img>
            <img src={pinni} alt="" className="img-reponsive"></img>
          </div>
